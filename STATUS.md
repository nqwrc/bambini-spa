...
## now
Published on GitHub Pages: a responsive Vite + Tailwind site for Bambini S.p.A., built from
scraped reference pages (aree-intervento, compliance, contatti, flotta, ecc.) now rendered as
a clean static site.
